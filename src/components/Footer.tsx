      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div className="flex flex-col items-start space-y-2">
          ...
          <p className="text-sm text-zinc-400 max-w-xs">
            A Hardstuck-Gold-Wattson main couldn&rsquo;t learn to win the 1v3 so instead he built this app to have fun with his friends. Hope you enjoy!
          </p>
        </div>

        {/* Navigation Links */}
        <div className="flex flex-col space-y-2 text-sm">
          <p className="uppercase text-zinc-500 font-semibold tracking-wide">Navigation</p>
        ...
        <div className="flex flex-col space-y-2 text-sm">
          <p className="uppercase text-zinc-500 font-semibold tracking-wide">More</p>
          <Link href="/terms" className="hover:text-red-400 transition">Terms</Link>
          <Link href="/privacy" className="hover:text-red-400 transition">Privacy</Link>
<Link
